...
const BrandBanner: React.FC = () => {
  ...
  useEffect(() => {
    ...
    script.src = 'https://unpkg.com/@massds/mayflower-assets@13.1.0/js/brand-banner.js';
    ...
    <div className="ma__brand-banner ma__brand-banner--c-primary-alt-bg-light">
      ...
      >
        ...
        <span className="ma__brand-banner-text">
          ...
          <span>   </span>
          <span
            className="ma__brand-banner-button ma__button-icon ma__icon-small ma__button-icon--quaternary ma__button-icon--c-primary-alt"
          >
